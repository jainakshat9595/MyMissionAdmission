	...
	taRegisterTool('insertImage', {
		...
		action: function(){
			...
			filepicker.pick(
			 {
			    mimetype: 'image/*',
			    services: ['COMPUTER', 'URL', 'FACEBOOK', 'CLOUDAPP']
			  },
			  function(Blob){
			    imageLink = Blob.url;
				if(imageLink && imageLink !== '' && imageLink !== 'http://'){
					$('body').append('<input class="imageLink" type="hidden" value="'+imageLink+'">');
					return tmpThis.$editor().wrapSelection('insertImage', imageLink, true);
				}
			  },
			  function(FPError){
